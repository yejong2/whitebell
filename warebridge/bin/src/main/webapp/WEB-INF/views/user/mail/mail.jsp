		...
		<div class="card bg-menu-theme sub-side-menu" style="height: 82vh">
			<div class="d-flex row">
				<div class="card-header d-grid">
					...
					<button class="btn btn-primary btn-compose" data-btn-location="/user/sendMail">메일 쓰기</button>
				</div>
				<div id="layout-menu" class="card-body row d-grid menu menu-vertical inner-sub-menu">
					<ul class="menu-inner">
						...
						<li class="menu-item"><a
							href="<%=request.getContextPath()%>/user/outMail"
							class="menu-link">
								<div class="sub-side-div">보낸 메일함</div>
						</a></li>
						<li class="menu-item"><a
							href="<%=request.getContextPath()%>/user/saveMail"
							class="menu-link">
								<div class="sub-side-div">임시 보관함</div>
						</a></li>
						<li class="menu-item"><a
							href="<%=request.getContextPath()%>/user/bookMail"
							class="menu-link">
								<div class="sub-side-div">예약 메일함</div>
						</a></li>
						<li class="menu-item"><a
							href="<%=request.getContextPath()%>/user/spamMail"
							class="menu-link">
								<div class="sub-side-div">스팸 메일함</div>
						</a></li>
						<li class="menu-item"><a
							href="<%=request.getContextPath()%>/user/vipMail"
							class="menu-link">
								<div class="sub-side-div">중요 메일함</div>
						</a></li>
						<li class="menu-item"><a
							href="<%=request.getContextPath()%>/user/binMail"
							class="menu-link">
			...
			<div class="col col-md-12 col-6">
				<div class="card">
					<div id="inner-card-body" class="card-body" style="height: 82vh">
						<h4 class="card-header">받은 메일함</h4>
