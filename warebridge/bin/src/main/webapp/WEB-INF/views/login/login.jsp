        ...
        <div class="authentication-inner row justify-content-md-center">
          ...
          <div class="card col-4" style="height: 90vh">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<%=request.getContextPath() %>/home" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit">얼굴인식 로그인</button>
                </div>
              </form>
