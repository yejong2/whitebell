        ...
        <div class="authentication-inner row justify-content-md-center">
          ...
          <div class="card col-4" style="height: 90vh">
            <div class="card-body">
              ...
              <p class="mb-4">비밀번호 초기화를 위해 인증번호가 이메일로 전송됩니다. 가입시 등록한 이메일을 입력해주세요.</p>
              <form id="formAuthentication" class="mb-3" action='<c:url value="/login/lostPw"/>'POST">
                <div class="mb-3">
              ...
              <div class="text-center">
                <a href='<c:url value="/"/>' class="d-flex align-items-center justify-content-center">
